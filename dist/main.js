...
/* harmony import */ var _js_countrieslist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/countrieslist */ "./src/client/js/countrieslist.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getRestCountries", function() { return _js_countrieslist__WEBPACK_IMPORTED_MODULE_1__["getRestCountries"]; });
...
/* harmony import */ var _countrieslist__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./countrieslist */ "./src/client/js/countrieslist.js");
...
const postData = async (url = ' ', data = {}) => {
  ...
  const res = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('http://localhost:3000', {
    method: 'POST',
...
const updateUI = async imageURL => {
  const req = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('http://localhost:3000/data')
  try {
    ...
    Object(_countrieslist__WEBPACK_IMPORTED_MODULE_0__["displayCountryInfo"])()
  } catch (error) {
    console.log('error', error)
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRestCountries", function() { return getRestCountries; });
...
node_fetch__WEBPACK_IMPORTED_MODULE_0___default()('https://restcountries.eu/rest/v2/all')
  .then(res => res.json())
